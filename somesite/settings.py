...
SECRET_KEY = '8engtxu^6c%rw1#vq0gwzq2x-x77zz2u05(vde%_dwomt_ee*e'
...
ACCOUNT_EMAIL_CONFIRM_EXPIRE_DAYS = 1
...
# Когда пользователь залогониться он вернется на эту сылку -> '/'
