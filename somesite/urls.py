...
urlpatterns = [
    ...
    path('profile/detail/<int:pk>', views.HomeDetailView.as_view(), name='detail_profile'),
    ...
    path('email/<int:detail_id>', views.get_email, name='email'),
    ...
    path('message/', views.SendMessageView.as_view(), name='get_message'),
